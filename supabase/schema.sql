...
insert into public.menu_entries (section_id, name, ingredients, base_name, benefit, category_slug, accent_color, price_idr, sort_order, is_available)
select menu_sections.id, cold_pressed_base.name, cold_pressed_base.ingredients, cold_pressed_base.base_name, cold_pressed_base.benefit, cold_pressed_base.category_slug, cold_pressed_base.accent_color, cold_pressed_base.price_idr, cold_pressed_base.sort_order, true
